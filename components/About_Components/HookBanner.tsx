...
const HookBanner = () => {
  return (
    <div className="min-h-[100dvh] px-4 md:px-12 bg-white bg-grid flex items-center">
      <div className="max-w-6xl mx-auto pb-20 flex flex-col md:flex-row items-center gap-5 pt-10 md:pt-0">
